...
def Change_annotation_type(ann_types):
    ...
    all_annotations=["s","Sentence boundaries","tok","Token","pos","POS tags","liaison","Liaison","pron","Pronunce"]
    
    if("tok" not in ann_types):
        ann_types.append("tok")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "-dictionary",  help="get word pronunciation")
    ...
    parser.add_argument("-a", "-annotations", help="choice what you need, ex: \"s-pos-liaison-pron-tok\"")
